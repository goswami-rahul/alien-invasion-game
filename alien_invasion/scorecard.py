...
class Scorecard:
	...
	def __init__(self, ai_settings: Settings, stats: GameStats, screen: pygame.SurfaceType):
		...
		self.font = pygame.font.SysFont("comicsansms", self.ai_settings.score_font_size)
	...
	def print_high_score_msg(self):
		if self.stats.score > self.stats.prev_high_score and self.stats.timer_flag:
			self.stats.time_to_blit = pygame.time.get_ticks() + 3000
			self.stats.timer_flag = False
